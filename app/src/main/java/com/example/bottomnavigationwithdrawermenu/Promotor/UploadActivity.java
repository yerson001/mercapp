...
public class UploadActivity extends AppCompatActivity {
    ...
    private static final String url="https://emaransac.com/mercapp/upload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("NAME_KEY")) {
            ...
            // Ahora puedes utilizar el valor "name" como desees
        ...
        RelativeLayout browse = findViewById(R.id.browse);
        RelativeLayout upload = findViewById(R.id.upload);
